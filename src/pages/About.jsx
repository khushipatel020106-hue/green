...
const About = () => {
  return (
    <div className="font-sans text-gray-800">
      ...
      {/* ================= PAGE HERO ================= */}
      <section className="relative overflow-hidden bg-green-950 text-white py-32 text-center">
          ...
          <div>
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-6">
              {[
                ...
                <div
                  key={index}
                  className="bg-white p-8 rounded-2xl text-center shadow hover:shadow-lg transition-all duration-300 hover:bg-green-950 hover:text-white"
                >
          ...
          <div>
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-6 text-center">
              {[
                ...
                <div
                  key={index}
                  className="relative bg-green-950 text-white p-10 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300"
                >
      ...
      <section className="bg-gradient-to-b from-gray-100 to-gray-200 py-32 text-center">
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="flex flex-wrap justify-center gap-6">
            <a
              href="/vehicles"
              className="bg-green-950 text-white px-10 py-4 rounded-full font-semibold hover:bg-gray-800 transition"
            >
              Explore Vehicles →
            </a>
